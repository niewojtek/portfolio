<?php
    ...
    /**
     * Sends email to the specified user, passing in corresponding values.
     */
    function mailReceipt($values)
    {
        ...
        $mail -> Port = 587;
        $mail -> Username = "fedorov.rus@gmail.com";
        $mail -> Password = "********"; // enter your password here
        $mail -> SetFrom("fedorov.rus@gmail.com", "Fedorov Igor");
        $mail -> AddAddress($email[0]["email"]);
        $mail -> Subject = "C$50 Finance Receipt";
        $mail -> Body =                 
            "transaction details:\n\n" .
